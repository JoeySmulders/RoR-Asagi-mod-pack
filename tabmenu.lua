...
TabMenu.setItemInfo(Item.find("See-through log"), 10, "Shoot out ninja stars every 10 seconds", "-1 seconds")
...
-- uncommon
TabMenu.setItemInfo(Item.find("Soul Devourer"), nil, "Hitting an enemy increases damage by 1, damage is lost when you take damage", "+1 damage")
...
-- rare
TabMenu.setItemInfo(Item.find("Punching Bag"), nil, "Reduce damage taken by 80% when standing perfectly still", nil)
