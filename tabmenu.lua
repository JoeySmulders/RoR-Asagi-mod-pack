...
TabMenu.setItemInfo(Item.find("Blood Economy"), nil, "Gain 5% of damage dealt or taken as gold", "5% more gold")
...
TabMenu.setItemInfo(Item.find("Fan of Blades"), nil, "33% on hit to launch a blade at the hit enemy. The blade deals 100% + 25% for each prior blade that hit the target", "+25% initial damage")
...
TabMenu.setItemInfo(Item.find("Cursed Longsword"), nil, "Home in on the first target that comes close to you, then continuously deal 150% damage", "+100% damage")
